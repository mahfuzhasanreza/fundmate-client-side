            ...
            {steps.map((step, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="relative inline-block mb-6">
                  <div className="w-20 h-20 bg-white border-4 border-primary-200 rounded-full flex items-center justify-center text-2xl font-bold text-primary-600 group-hover:border-primary-500 group-hover:scale-110 transition-all duration-300 relative z-10">
                    {step.number}
                  </div>
                ...
                {/* Icon */}
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-primary-100 text-primary-600 mb-6 group-hover:bg-primary-600 group-hover:text-white transition-all duration-300">
                  {step.icon}
                </div>
