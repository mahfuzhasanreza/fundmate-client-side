...
import { registerWithFirebase, signInWithGoogle, signInWithGithub } from '../services/firebaseAuthService'
      ...
      >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center space-x-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-primary-300 hover:bg-primary-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          {/* <motion.button
            ...
            whileHover={{ scale: 1.02, boxShadow: "0 10px 20px rgba(0,0,0,0.1)" }}
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center space-x-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-gray-800 hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Github className="h-5 w-5 text-gray-800" />
            <span className="text-sm font-semibold text-gray-700">Sign up with GitHub</span>
          </motion.button> */}
        </motion.div>
        ...
        >
          ...
          <motion.button
            type="submit"
            disabled={formData.password !== formData.confirmPassword || !formData.agreeToTerms || isLoading}
